...
public class GovUkValidateCheckboxNumberOfResponsesRangeAttribute : ValidationAttribute
{
    ...
    /// </summary>
    public int? MinimumSelected { get; set; } = null;
    ...
    /// </summary>
    public int? MaximumSelected { get; set; } = null;
    ...
    protected override ValidationResult IsValid(object value, ValidationContext validationContext)
    {
        ...
        if (MinimumSelected.HasValue &&
            selectedValues.Count < MinimumSelected.Value)
        {
